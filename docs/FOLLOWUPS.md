...
- **Media normalization** — Residuals: **documents** still pass through untouched; tune the
  ...
  multi-target fan-out. Some services, such as Telegram, do not have media handling implemented.
...
- **Platform-secret management** — Trigger signing-key management remains a future catalog extension.
