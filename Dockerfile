...
WORKDIR /app
# curl is required by the container healthcheck; ffmpeg by media normalization (FFMpegCore shells
# out to it) in the posting worker. Neither is present in the aspnet base image.
RUN apt-get update \
