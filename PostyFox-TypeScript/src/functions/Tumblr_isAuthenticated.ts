...
async function Tumblr_IsAuthenticated(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('Tumblr_IsAuthenticated', {
    methods: ['POST'],
    authLevel: "anonymous",
    handler: Tumblr_IsAuthenticated
});